...
The current repository is organized around these areas:
...
At runtime, Leon receives input, chooses a route, executes work through skills or tools, observes results, and returns an answer.
