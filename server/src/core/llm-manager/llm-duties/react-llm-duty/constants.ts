...
export const AGENT_COMPUTER_USE_CONVERGENCE_CALL_THRESHOLD = 8
export const AGENT_COMPUTER_USE_SCROLL_REVERSAL_THRESHOLD = 2
export const AGENT_COMPUTER_USE_REPEATED_POINT_THRESHOLD = 3
export const AGENT_COMPUTER_USE_POINT_PROXIMITY_PX = 24
