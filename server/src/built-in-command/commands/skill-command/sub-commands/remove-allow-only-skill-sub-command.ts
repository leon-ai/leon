...
import {
  ...
  resolveSkillEntry,
  SKILL_REMOVE_ALLOW_ONLY_SUBCOMMAND,
...
export class RemoveAllowOnlySkillSubCommand implements SkillSubCommand {
  public readonly name = SKILL_REMOVE_ALLOW_ONLY_SUBCOMMAND
  public readonly description = 'Remove a skill from the allow-only list.'
  public readonly iconName = 'ri-delete-back-line'
  ...
  public async execute(
    ...
    await ProfileHelper.removeAllowOnlySkill(skillEntry.skillName)

    return createSkillAllowOnlySuccessResult('removed', skillEntry)
  }
}
