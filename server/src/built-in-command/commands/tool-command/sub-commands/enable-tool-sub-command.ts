...
export class EnableToolSubCommand implements ToolSubCommand {
  public readonly name = TOOL_ENABLE_SUBCOMMAND
  public readonly description = 'Enable a disabled tool.'
  ...
  public async execute(
    ...
    await ProfileHelper.enableTool(toolEntry.qualifiedName)

    return createToolToggleSuccessResult('enabled', toolEntry)
  }
}
