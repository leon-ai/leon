...
import {
  ...
  resolveToolEntry,
  TOOL_REMOVE_ALLOW_ONLY_SUBCOMMAND,
...
export class RemoveAllowOnlyToolSubCommand implements ToolSubCommand {
  public readonly name = TOOL_REMOVE_ALLOW_ONLY_SUBCOMMAND
  public readonly description = 'Remove a tool from the allow-only list.'
  ...
  public async execute(
    ...
    await ProfileHelper.removeAllowOnlyTool(toolEntry.qualifiedName)

    return createToolAllowOnlySuccessResult('removed', toolEntry)
  }
}
